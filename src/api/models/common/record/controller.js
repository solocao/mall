...
Controller.prototype.list = function (request, reply) {
    ...
    this.service.list(where, request.query.page_size, request.query.page_number, 'record_id asc').then(function (list) {
        var data = [];
...
Controller.prototype.get = function (request, reply) {
    ...
    var where = { record_id: request.params.record_id };
